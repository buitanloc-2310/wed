...
- Đăng nhập hỗ trợ Email + Mật khẩu và Google qua Firebase Authentication. Tài khoản Google khởi tạo đầu tiên phải khớp `VITE_INITIAL_ADMIN_EMAIL`; không có cơ chế “người đầu tiên đăng nhập tự thành quản trị viên”.
