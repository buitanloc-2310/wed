      ...
      >
        ...
        <div className="p-4 sm:p-5 border-b border-slate-100 flex items-center gap-3 bg-slate-50/70">
          ...
          <input
            ...
            placeholder="Tìm kiếm chương trình, bài viết, hoạt động tiếng Anh..."
        ...
        <div className="overflow-y-auto p-4 sm:p-6 space-y-6 divide-y divide-slate-100">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-xs sm:text-sm font-bold text-slate-800">Khóa học tiếng Anh</span>
                  </div>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-xs sm:text-sm font-bold text-slate-800">Bản tin Tên chủ tài khoản đã được xác nhận</span>
                  </div>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-xs sm:text-sm font-bold text-slate-800">Tra cứu Giấy chứng nhận</span>
                  </div>
              ...
              {sfecMatches && (
                <div className="space-y-2.5 pt-4">
                  <div className="text-xs font-extrabold text-amber-600 uppercase tracking-wider flex items-center gap-1.5">
                    ...
                    <span>Câu lạc bộ Tiếng Anh The Sky First</span>
                  </div>
                  <button
                    onClick={() => {
                      onNavigate('units');
                  ...
                  >
                    <div>
                      <div className="text-xs font-bold text-slate-900">
                        Hoạt động của Câu lạc bộ Tiếng Anh The Sky First
                      </div>
          ...
          {trimmed && !hasResults && (
            <div className="text-center py-8 space-y-2">
              ...
              <p className="text-xs text-slate-500">
                Vui lòng thử tìm kiếm bằng từ khóa khác như "giáo dục", "tình nguyện", "tiếng Anh", "cộng đồng"...
              </p>
            </div>
          )}
        ...
        <div className="p-3 bg-slate-50 border-t border-slate-100 px-5 flex items-center justify-between text-[11px] text-slate-400">
          ...
          <span>Tìm kiếm thông minh trên toàn mạng lưới Tên chủ tài khoản đã được xác nhận</span>
        </div>
      </div>
    </div>
  );
