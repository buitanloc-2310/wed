...
export const AdminCertificatesManager: React.FC<AdminCertificatesManagerProps> = ({
  ...
  const handleCreateNew = () => {
    ...
    const newCode = `SFCA-2026-HQ-${randomNum}`;

    const newCert: Certificate = {
      code: newCode,
      recipientName: 'Nguyễn Văn A',
      recipientEmail: 'nguyenvana@gmail.com',
      recipientPhone: '0901 234 567',
      programTitle: 'Khóa Huấn Luyện Thủ Lĩnh Thanh Niên SFN 2026',
      programType: 'Khóa Đào Tạo',
      issueDate: new Date().toLocaleDateString('vi-VN'),
      expiryDate: 'Vô thời hạn',
      status: 'valid',
      issuer: 'Hội đồng Quản trị Sky First Network',
      verificationUrl: `https://skyfirst.io.vn/sfca?code=${newCode}`,
      signatory: {
        name: 'Đại diện Ban Điều Phối',
        title: 'Chủ tịch Mạng lưới'
      },
      isPublished: true
    };
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-5 rounded-2xl border border-slate-200/80 shadow-xs">
          <div>
            <h2 className="text-lg font-black text-slate-900 tracking-tight flex items-center gap-2">
              ...
              Danh Sách Chứng Nhận Số SFCA ({certificates.length})
            </h2>
        ...
        <div className="bg-white p-3.5 rounded-2xl border border-slate-200/80 shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          ...
          <div className="relative flex-1 max-w-sm">
            ...
            <input
              ...
              placeholder="Tìm theo mã SFCA, tên người nhận, chương trình..."
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div>
            <label className="text-xs font-bold text-slate-700 block mb-1">
              Mã Chứng Nhận Số SFCA <span className="text-rose-500">*</span>
            </label>
            <input
              type="text"
