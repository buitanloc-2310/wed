      ...
      <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-lg font-black text-slate-900 tracking-tight flex items-center gap-2">
            ...
            Cấu hình chung & Nhận diện thương hiệu Tên chủ tài khoản đã được xác nhận
          </h2>
      ...
      {activeSubSection === 'contact' && (
        <div className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200/80 shadow-xs space-y-6">
          <div className="border-b border-slate-100 pb-3">
            ...
            <p className="text-xs text-slate-500 mt-0.5">
              Địa chỉ liên hệ (nếu công khai), số điện thoại tiếp nhận thông tin và liên kết mạng xã hội chính thức.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder="© 2026. Bản quyền nội dung thuộc Mạng lưới Giáo dục & Phát triển Cộng đồng Sky First."
