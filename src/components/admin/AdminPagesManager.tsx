...
const SYSTEM_PAGES: SystemFixedPage[] = [
  {
    id: 'fixed-about',
    slug: 'gioi-thieu',
    title: 'Giới thiệu & Ban Điều phối Sky First Network',
    summary: 'Cấu trúc thông tin trang giới thiệu, thành viên ban điều phối, trụ cột sứ mệnh và lộ trình phát triển mạng lưới.',
  ...
  },
  {
    ...
    summary: 'Danh mục các câu hỏi và giải đáp chính thức về mạng lưới Sky First Network, cấp chứng nhận số SFCA và cơ chế đồng hành.',
    author: 'Ban Điều phối Sky First Network',
    date: '2026',
    type: 'fixed-faqs',
    publicRoute: 'home',
...
export const AdminPagesManager: React.FC<AdminPagesManagerProps> = ({
      ...
      <div className="flex flex-col min-h-screen bg-[#F8F9FA] -m-4 sm:-m-6">
          ...
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="truncate">
              ...
              <h2 className="text-sm sm:text-base font-bold text-slate-900 truncate">
                Giới Thiệu & Ban Điều phối Sky First Network
              </h2>
            </div>
          </div>
        ...
        <div className="p-4 sm:p-6 max-w-6xl mx-auto w-full">
          <div className="mb-4 bg-sky-50/80 border border-sky-200/80 rounded-xl p-4 text-xs text-sky-900 flex items-start gap-3">
            ...
            <div>
              <p className="font-bold text-sm text-[#0284C7]">Trang Giới Thiệu & Ban Điều Phối</p>
              <p className="mt-0.5 text-slate-600 leading-relaxed">
                Biểu mẫu có sẵn bên dưới cho phép bạn cập nhật danh sách Ban điều phối, trụ cột sứ mệnh và lộ trình phát triển. Mọi thay đổi được lưu tự động theo thời gian thực.
              </p>
            </div>
          </div>
  ...
  if (viewMode === 'edit-custom' && activeCustomPage) {
    ...
    return (
      <div className="flex flex-col min-h-screen bg-[#F8F9FA] -m-4 sm:-m-6">
        {/* Editor Top Bar (Blogger Post Editor Header) */}
        <div className="h-16 bg-white border-b border-slate-200 px-4 sm:px-6 flex items-center justify-between gap-4 sticky top-0 z-30 shadow-2xs">
        ...
        <div className="flex-1 flex overflow-hidden">
              ...
              <div className="p-6 sm:p-10 pb-4 border-b border-slate-100">
                ...
                <div className="mt-2.5 flex items-center gap-4 text-xs text-slate-500">
                  <span className="flex items-center gap-1">
                    ...
                    {activeCustomPage.author || 'Ban Điều phối Sky First Network'}
                  </span>
                  <span className="flex items-center gap-1">
          ...
          {/* Right Inspector Sidebar ("Cài đặt trang" - matching Blogger Post Settings) */}
          <div className="w-80 border-l border-slate-200 bg-white overflow-y-auto hidden lg:block shrink-0 shadow-xs">
            <div className="p-4 border-b border-slate-200 bg-slate-50 flex items-center justify-between">
              ...
              <span className="text-[11px] text-slate-500">Google Blogger CMS</span>
            </div>
            ...
            <div className="bg-white rounded-2xl max-w-3xl w-full max-h-[90vh] flex flex-col shadow-2xl overflow-hidden">
              ...
              <div className="p-6 sm:p-8 overflow-y-auto space-y-4">
                ...
                <div className="flex items-center gap-4 text-xs text-slate-500 pb-4 border-b border-slate-100">
                  <span>Tác giả: {activeCustomPage.author || 'Ban Điều phối Sky First Network'}</span>
  ...
  // ==========================================
  // VIEW 4: MAIN LIST VIEW (EXACT GOOGLE BLOGGER INTERFACE)
  // ==========================================
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white p-3 rounded-2xl border border-slate-200/90 shadow-2xs">
        {/* Left: Button "TRANG MỚI" (Orange Blogger style) + Status Filter */}
            ...
            >
              <div className="flex items-center gap-3.5 min-w-0 flex-1">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="mt-1.5 flex items-center gap-3 text-xs text-slate-400">
                    <span>{page.author || 'Ban Điều phối Sky First Network'}</span>
                    <span>•</span>
