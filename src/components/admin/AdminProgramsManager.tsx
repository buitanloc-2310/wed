...
export const AdminProgramsManager: React.FC<AdminProgramsManagerProps> = ({
  ...
  const handleCreateNew = () => {
    ...
    const newProg: Program = {
      ...
      title: initialTitle,
      category: 'volunteer',
      categoryLabel: 'Tình nguyện & Xã hội',
      status: 'open',
      statusLabel: 'Đang mở đơn',
      summary: 'Tóm tắt nội dung ngắn gọn và thông điệp trọng tâm của dự án.',
      description: 'Mô tả chi tiết mục tiêu, phạm vi tác động và các hoạt động chính của dự án.',
      ...
      theme: 'emerald',
      date: 'Tháng 06/2026 - Tháng 08/2026',
      location: 'Hà Nội & TP. Hồ Chí Minh',
      targetAudience: 'Học sinh, Sinh viên từ 16 - 26 tuổi',
      spotsLeft: 30,
      timeline: [
        'Giai đoạn 1: Mở cổng tiếp nhận hồ sơ đăng ký trực tuyến',
        'Giai đoạn 2: Phỏng vấn & Hoàn thiện danh sách thành viên',
        'Giai đoạn 3: Triển khai chiến dịch thực địa tại địa phương'
      ],
      benefits: [
        'Cấp Giấy chứng nhận hoàn thành có mã số SFCA và mã QR tra cứu toàn quốc',
        'Hỗ trợ chi phí đi lại, bảo hiểm hoạt động và trang thiết bị thực địa',
        'Môi trường rèn luyện kỹ năng lãnh đạo, làm việc nhóm và kết nối chuyên gia'
      ],
      requirements: [
        'Tinh thần trách nhiệm, chủ động và nhiệt huyết vì cộng đồng',
        'Cam kết tham gia đầy đủ các buổi tập huấn và lịch trình hoạt động'
      ],
      isPublished: true
    };
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-xs space-y-4">
          ...
          <div className="pt-2 flex items-center gap-2">
            <input
              ...
              placeholder="Nhập quyền lợi mới (ví dụ: Cấp giấy chứng nhận SFCA, hỗ trợ phụ cấp...)..."
              className="flex-1 px-3 py-2 bg-white border border-slate-200 rounded-xl text-xs text-slate-900 focus:outline-hidden focus:border-sky-500"
            />
            <button
              type="button"
