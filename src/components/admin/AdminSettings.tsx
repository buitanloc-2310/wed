...
export const AdminSettings: React.FC<AdminSettingsProps> = ({
  ...
  const handleSaveUser = () => {
    ...
    // Kiểm tra định dạng email và đuôi gmail
    ...
    if (!trimmedEmail.endsWith('@gmail.com')) {
      setEmailError('Yêu cầu sử dụng tài khoản địa chỉ @gmail.com theo quy định');
      return;
    }
    ...
    if (!editingUser) {
      ...
      if (isDuplicate) {
        setEmailError('Địa chỉ Gmail này đã tồn tại trong danh sách');
        return;
      }
    }
    ...
    if (editingUser) {
      ...
      onShowToast(`Đã thêm tài khoản Gmail ${trimmedEmail} thành công!`);
    }
