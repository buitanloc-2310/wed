...
export const AdminSidebar: React.FC<AdminSidebarProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="pt-4 px-4 pb-2">
        <div className={`flex items-center ${collapsed?'justify-center':'gap-3'} px-2 py-1.5`}>
          <div className="w-10 h-10 rounded-xl bg-white border border-slate-200 p-1 flex items-center justify-center shrink-0">
            <img src="/brand/sky-first-network-web.png" alt="Sky First Network" className="w-full h-full object-contain" />
          </div>
      ...
      {/* 2. Prominent "+ BÀI ĐĂNG MỚI" / "+ TẠO MỚI" Button (giao diện quản trị) */}
      ...
      {/* 3. Navigation List (mục quản trị) */}
      ...
      {/* 4. Footer Legal Links (giao diện quản trị) */}
      {!collapsed && (
