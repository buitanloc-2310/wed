...
export const AdminUnitsManager: React.FC<AdminUnitsManagerProps> = ({
  ...
  const handleCreateNew = () => {
    ...
    const newUnit: NetworkUnit = {
      ...
      isFlagship: false,
      leader: {
        name: 'Ban Lãnh Đạo SFN',
        title: 'Trưởng Ban Điều Hành Đơn Vị'
      },
      description: 'Mô tả tổng quan về vai trò, chức năng và sứ mệnh hoạt động của đơn vị trong hệ sinh thái SFN.',
        ...
        {filteredUnits.length === 0 ? (
          <div className="bg-white rounded-2xl border border-slate-200 p-12 text-center shadow-xs">
            ...
            <p className="text-xs text-slate-500 mb-5">
              Bắt đầu tạo đơn vị trực thuộc đầu tiên trong hệ sinh thái SFN.
            </p>
            <button
              type="button"
                      ...
                      <div className="flex items-center gap-2.5">
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <p className="text-[11px] text-slate-500 italic truncate mt-0.5">
                            "{unit.tagline || 'Đơn vị trực thuộc hệ sinh thái SFN'}"
                          </p>
                        </div>
                      </div>
                    </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
              ...
              <div className="sm:col-span-3">
                ...
                <input
                  ...
                  placeholder="Ví dụ: Trung Tâm Giáo Dục & Kỹ Năng SFN (SFEC)"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                >
                  ...
                  <option value="emerald">Xanh Lá (Emerald - SFYC)</option>
                  <option value="indigo">Xanh Chàm (Indigo - SFIR)</option>
                  <option value="rose">Hồng Đỏ (Rose - SFMC)</option>
                  <option value="amber">Cam Vàng (Amber - SFCA)</option>
                </select>
              </div>
            </div>
          </div>
