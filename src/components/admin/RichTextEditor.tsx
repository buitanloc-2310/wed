...
export const RichTextEditor: React.FC<RichTextEditorProps> = ({
  ...
  const handleInsertTable = () => {
    applyFormat('insertHTML', '<table><thead><tr><th>Tiêu đề 1</th><th>Tiêu đề 2</th></tr></thead><tbody><tr><td>Nội dung</td><td>Nội dung</td></tr></tbody></table><p><br></p>');
  };
    ...
    <div id={id} className="rounded-xl border border-slate-200 bg-white overflow-hidden shadow-2xs transition-all focus-within:border-[#0284C7] focus-within:ring-2 focus-within:ring-sky-100">
      ...
      <div className="bg-slate-50/90 border-b border-slate-200 px-3 py-2 flex flex-wrap items-center justify-between gap-1.5 select-none">
        <div className="flex flex-wrap items-center gap-1">
          ...
          <button type="button" onClick={() => applyFormat('undo')} disabled={isCodeView} className="p-1.5 text-slate-600 hover:bg-white rounded-lg" title="Hoàn tác"><Undo2 size={15}/></button>
          <button type="button" onClick={() => applyFormat('redo')} disabled={isCodeView} className="p-1.5 text-slate-600 hover:bg-white rounded-lg" title="Làm lại"><Redo2 size={15}/></button>
          <button type="button" onClick={() => applyFormat('justifyLeft')} disabled={isCodeView} className="p-1.5 text-slate-600 hover:bg-white rounded-lg" title="Căn trái"><AlignLeft size={15}/></button>
          <button type="button" onClick={() => applyFormat('justifyCenter')} disabled={isCodeView} className="p-1.5 text-slate-600 hover:bg-white rounded-lg" title="Căn giữa"><AlignCenter size={15}/></button>
          <button type="button" onClick={() => applyFormat('justifyRight')} disabled={isCodeView} className="p-1.5 text-slate-600 hover:bg-white rounded-lg" title="Căn phải"><AlignRight size={15}/></button>
