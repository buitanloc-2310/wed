...
export const CertificateEditorFields: React.FC<CertificateEditorFieldsProps> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-xs space-y-4">
        ...
        <div>
          ...
          <input
            ...
            placeholder="SFCA DIGITAL VERIFICATION"
        ...
        <div>
          ...
          <input
            ...
            placeholder="Tra Cứu Giấy Chứng Nhận (GCN)"
      ...
      {/* 2. KHUNG TÌM KIẾM & TRA CỨU CHỨNG NHẬN SFCA */}
      <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-xs space-y-4">
        <div className="flex items-center justify-between pb-3 border-b border-slate-100">
          <div className="flex items-center gap-2">
            <Search size={16} className="text-[#0284C7]" />
            <h3 className="text-sm font-extrabold text-slate-900">
              2. Khung Tra Cứu Chứng Nhận Điện Tử SFCA
            </h3>
          </div>
          <span className="text-[11px] text-slate-400 font-medium">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="Nhập mã chứng nhận (Ví dụ: SFN-2026-OK)"
        ...
        <div className="pt-2 border-t border-slate-100">
          ...
          <textarea
            ...
            placeholder="Hệ thống tra cứu tự động đối chiếu mã số với cơ sở dữ liệu số hóa SFCA theo thời gian thực."
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-xs space-y-4">
        <div className="flex items-center justify-between pb-3 border-b border-slate-100">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-sm font-extrabold text-slate-900">
              3. Khối 3 Cột Quy Chuẩn Minh Bạch (Tiêu Chuẩn SFCA)
            </h3>
          </div>
          <span className="text-[11px] text-slate-400 font-medium">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="p-4 rounded-xl bg-sky-50/50 border border-sky-100 space-y-2.5">
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Mỗi chứng nhận được cấp một mã số duy nhất theo định dạng SFN-[NĂM]-[MÃ]..."
          ...
          <div className="p-4 rounded-xl bg-emerald-50/50 border border-emerald-100 space-y-2.5">
            <div className="flex items-center gap-1.5 text-xs font-bold text-emerald-700">
              ...
              <span>Cột 2: Lưu Trữ Vĩnh Viễn</span>
            </div>
            <div>
              <label className="block text-[11px] font-bold text-slate-600 mb-1">Tiêu đề</label>
              <input
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Hồ sơ được lưu trữ trên cơ sở dữ liệu số của SFN phục vụ đối chiếu..."
        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Đội ngũ điều phối và kỹ thuật viên SFCA luôn sẵn sàng giải đáp và xử lý yêu cầu xác minh thông tin..."
              className="w-full text-xs text-slate-700 px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl focus:border-[#0284C7] focus:outline-hidden leading-relaxed"
            />
          </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-xs space-y-3">
        ...
        <p className="text-xs text-slate-500 leading-relaxed">
          Bạn có thể nhập nội dung văn bản giới thiệu quy chế cấp chứng nhận, tiêu chuẩn đối chiếu SFCA hoặc dán trực tiếp từ văn bản Word, Docs (tự động giữ nguyên định dạng in đậm, danh sách, bảng biểu).
        </p>
        ...
        <div>
          <RichTextEditor
            ...
            placeholder="Nhập hoặc dán nội dung quy chuẩn chứng nhận SFCA..."
            minHeight="220px"
          />
        </div>
      </div>
