    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-xs space-y-4">
        <div className="flex items-center justify-between pb-3 border-b border-slate-100">
          ...
          <span className="text-[11px] text-slate-400 font-medium">
            Danh bạ chuyên biệt từng đơn vị SFEC, hoạt động tình nguyện, hoạt động nghiên cứu, hoạt động truyền thông, hệ thống Giấy chứng nhận
          </span>
        </div>
        ...
        <div className="p-3 bg-sky-50/50 rounded-xl border border-sky-100 text-xs text-slate-600 space-y-1">
          ...
          <p className="text-[11px] leading-relaxed">
            Danh sách các đơn vị trực thuộc (SFEC, hoạt động tình nguyện, hoạt động nghiên cứu, hoạt động truyền thông, hệ thống Giấy chứng nhận) cùng email và số điện thoại phụ trách được liên kết tự động từ mục Quản Lý Đơn Vị Mạng Lưới để người gửi có thể bấm chọn kết nối ngay lập tức.
          </p>
        </div>
      </div>
        ...
        <div className="space-y-4 pt-2">
          ...
          <div className="p-4 rounded-xl bg-slate-50/70 border border-slate-200 space-y-2">
            ...
            <textarea
              ...
              placeholder="Bạn có thể chọn trực tiếp đơn vị mong muốn (SFEC, hoạt động tình nguyện, hoạt động nghiên cứu, hoạt động truyền thông, hệ thống Giấy chứng nhận)..."
              className="w-full text-xs px-3 py-2 bg-white border border-slate-200 rounded-lg focus:outline-hidden leading-relaxed"
            />
          </div>
