...
export const DEFAULT_SITE_CONFIG: SiteConfig = {
  ...
  navigationGroups:[
    ...
    {label:'Đơn vị trực thuộc',items:[{label:'Câu lạc bộ Tiếng Anh The Sky First',page:'custom-page',slug:'cau-lac-bo-tieng-anh-the-sky-first'},{label:'Nhà Hán Ngữ',page:'custom-page',slug:'nha-han-ngu'}]},
  ...
  footerContacts:[{label:'Email liên hệ chính',value:'skyfirst.ec@gmail.com',url:'mailto:skyfirst.ec@gmail.com',icon:'mail'},{label:'Email Nhân sự',value:'nhansu.sfn@gmail.com',url:'mailto:nhansu.sfn@gmail.com',icon:'mail'},{label:'Email Hỗ trợ',value:'hotro.sfn@gmail.com',url:'mailto:hotro.sfn@gmail.com',icon:'mail'},{label:'Email Hợp tác',value:'hoptac.sfn@gmail.com',url:'mailto:hoptac.sfn@gmail.com',icon:'mail'},{label:'Email Truyền thông',value:'truyenthong.sfn@gmail.com',url:'mailto:truyenthong.sfn@gmail.com',icon:'mail'},{label:'Điện thoại liên hệ',value:'0924 910 210',url:'tel:0924910210',icon:'phone'},{label:'Facebook',value:'skyfirstnetwork',url:'https://facebook.com/skyfirstnetwork',icon:'facebook'},{label:'Instagram',value:'sfn.network',url:'https://instagram.com/sfn.network',icon:'instagram'},{label:'TikTok',value:'@sfn.network',url:'https://tiktok.com/@sfn.network',icon:'message'},{label:'Zalo',value:'0924 910 210',url:'https://zalo.me/0924910210',icon:'message'}],
  footerPortals:[{label:'Cổng chính Sky First Network',domain:'skyfirst.io.vn',url:'https://skyfirst.io.vn/',icon:'globe'},{label:'Cổng Thành viên',domain:'member.skyfirst.io.vn',url:'https://member.skyfirst.io.vn/',icon:'users'},{label:'Cổng Tình nguyện viên',domain:'tnv.skyfirst.io.vn',url:'https://tnv.skyfirst.io.vn/',icon:'heart'},{label:'Cổng Thông tin',domain:'ctt.skyfirst.io.vn',url:'https://ctt.skyfirst.io.vn/',icon:'globe'},{label:'Cổng SFEC',domain:'ctt.sfec.skyfirst.io.vn',url:'https://ctt.sfec.skyfirst.io.vn/',icon:'graduation'},{label:'Nhà Hán Ngữ',domain:'ctt.nhahanngu.io.vn',url:'https://ctt.nhahanngu.io.vn/',icon:'graduation'},{label:'Cổng Học thuật',domain:'academic.skyfirst.io.vn',url:'https://academic.skyfirst.io.vn/',icon:'graduation'}],
