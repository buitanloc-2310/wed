...
export const DEFAULT_SITE_CONFIG: SiteConfig = {
  ...
  footerContacts:[{label:'Email liên hệ chính',value:'skyfirst.ec@gmail.com',url:'mailto:skyfirst.ec@gmail.com',icon:'mail'},{label:'Email Nhân sự',value:'nhansu@skyfirst.io.vn',url:'mailto:nhansu@skyfirst.io.vn',icon:'mail'},{label:'Email Hỗ trợ',value:'support@skyfirst.io.vn',url:'mailto:suopport@skyfirst.io.vn',icon:'mail'},{label:'Email Hợp tác',value:'hoptac@skyfirst.io.vn',url:'mailto:hoptac@skyfirst.io.vn',icon:'mail'},{label:'Email Truyền thông',value:'truyenthong@skyfirst.io.vn',url:'mailto:truyenthong@skyfirst.io.vn',icon:'mail'},{label:'Điện thoại/Zalo',value:'0924 910 210',url:'tel:0924910210',icon:'phone'}],
