...
export const DEFAULT_SITE_CONFIG: SiteConfig = {
  ...
  footerPortals:[{label:'Cổng Thành viên',domain:'member.skyfirst.io.vn',url:'https://member.skyfirst.io.vn/',icon:'users'},{label:'Cổng Tình nguyện viên',domain:'tnv.skyfirst.io.vn',url:'https://tnv.skyfirst.io.vn/',icon:'heart'},{label:'Cổng Thông tin',domain:'ctt.skyfirst.io.vn',url:'https://ctt.skyfirst.io.vn/',icon:'globe'},{label:'Cổng Học thuật',domain:'academic.skyfirst.io.vn',url:'https://academic.skyfirst.io.vn/',icon:'graduation'}],
