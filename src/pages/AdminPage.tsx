...
const MENU_ITEMS: MenuItemConfig[] = [
  ...
  { id:'menus', label:'Menu website', icon:<Menu size={18}/>, largeIcon:<Menu size={24}/> },
...
const {
  ...
  // Phiên đăng nhập của Quản trị viên qua Gmail
  ...
  // =========================================================================
  // NẾU CHƯA ĐĂNG NHẬP GMAIL: HIỂN THỊ GIAO DIỆN ĐĂNG NHẬP /ADMIN
  // =========================================================================
  if (!currentAdminUser) {
    return (
      <AdminLogin
    ...
    <div className="min-h-screen bg-[#F8FAFC] text-slate-900 flex font-sans">
        ...
        <div className="h-16 border-b border-slate-200 px-4 flex items-center justify-between gap-2">
          {!isSidebarCollapsed ? (
            <div className="flex items-center gap-2.5 min-w-0 overflow-hidden">
              <div className="w-8 h-8 rounded-xl bg-linear-to-br from-sky-600 to-blue-700 text-white flex items-center justify-center font-bold text-xs shrink-0 shadow-xs">
                SFN
              </div>
            ...
            <div className="mx-auto">
              <div className="w-8 h-8 rounded-xl bg-linear-to-br from-sky-600 to-blue-700 text-white flex items-center justify-center font-bold text-xs shadow-xs">
                SFN
              </div>
            </div>
          )}
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-y-auto">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500">
              {activeTab === 'pages'
                ...
                : activeTab === 'layout'
                ? 'Mô phỏng và chỉnh sửa các khối trên trang chủ SFN'
                : activeTab === 'settings'
                ? 'Thiết lập nhận diện thương hiệu, tài khoản Gmail và đóng/mở website'
        ...
        <div className="p-6 max-w-6xl w-full mx-auto">
          ...
          {(['comments','registrations','contacts','certificates','partners','contributions','media','menus','logs'] as AdminTab[]).includes(activeTab) && (
