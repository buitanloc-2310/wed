      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-sky-50 border border-sky-200 text-xs font-black text-[#0284C7]">
            <span>HỆ THỐNG HOẠT ĐỘNG SFN 2026</span>
          </div>
          <h1 className="text-3xl sm:text-5xl font-black text-slate-900 tracking-tight">
            Chương Trình Hoạt Động
          </h1>
          <p className="text-slate-600 text-sm sm:text-base leading-relaxed font-normal">
            Khám phá các khóa đào tạo, chiến dịch tình nguyện và workshop thực chiến do Sky First Network cùng các đơn vị trực thuộc triển khai trên phạm vi toàn quốc.
          </p>
        </motion.div>
      </section>
