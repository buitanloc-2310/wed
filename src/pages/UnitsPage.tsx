  ...
  return <main className="bg-white">
    <section className="bg-[#071B3A] text-white py-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-xs uppercase tracking-[.18em] text-sky-200 font-black">Đơn vị trực thuộc</div>
        <h1 className="mt-4 text-5xl lg:text-6xl font-black tracking-[-.045em]">Các đơn vị trực thuộc Sky First Network</h1>
    ...
    <section className="py-16 lg:py-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <button onClick={() => onNavigate('contact')} className="inline-flex items-center gap-2 rounded-xl bg-[#0B5FB4] text-white px-5 py-3 font-bold">Liên hệ Sky First Network <ArrowRight size={17}/></button>
      </div>
    </section>
  </main>;
};
